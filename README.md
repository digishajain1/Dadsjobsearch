...
- Search + filters (location, tracker status, latest/all position toggle, and 60+ age-friendliness)
...
- Direct company career page links for executive roles when available
